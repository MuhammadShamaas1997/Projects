...
def greedy_rand(n, s, K, H, Q, r, C, Xcoord, Ycoord, c, h, u, I_total, d_total, inventory):
        ...
        while n >= len(coveredNodes):
            ...
            for v in vehicles:                
                ...
                for nodeStat in stats:
                    ...
                    if (((nodeStat["revenue"] - inventory[nodeStat["nodeId"]]["quantity"] * nodeStat["holdingCost"] - nodeStat["transportCost"]) < nodeDemand * sellingCost) and (inventory[nodeStat["nodeId"]]["quantity"] >= nodeDemand)):
...
def main(file_path):
    ...
    greedy_rand(n, s, K, H, Q, r, C, Xcoord, Ycoord, c, h, u, I_total, d_total, inventory)
...
with open('/Users/karijonsigurdsson/Desktop/4-Semester/MODEL/pirp/pirp-10-2-1-3-1.dat', 'r') as file:
