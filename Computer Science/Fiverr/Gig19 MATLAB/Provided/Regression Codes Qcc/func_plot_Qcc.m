function func_plot_Qcc(func_name, dim_x, dim_y)
    ...
    colormap jet;
    title(['Cooling Capacity: ', variable_names{dim_x}, ' vs ', variable_names{dim_y}], 'FontSize', 14, 'FontWeight', 'bold');
    xlabel(variable_names{dim_x}, 'FontSize', 12);
    ylabel(variable_names{dim_y}, 'FontSize', 12);
    zlabel('Cooling Capacity (Q_{cc})', 'FontSize', 12);
    grid on;
end
% func_plot_Qcc('Cooling_Capacity', dim_x, dim_y);
% func_plot_Qcc('Qcc', 1, 3);
% func_plot_Qcc('Qcc', 1, 2);
% func_plot_Qcc('Qcc', 1, 4);
% func_plot_Qcc('Qcc', 1, 5);