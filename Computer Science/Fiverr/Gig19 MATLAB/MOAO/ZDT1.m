...
function o = ZDT1(x)
o(1)=62.19 + 0.4573.*x(1) + 0.0259 .*x(2) - 0.02421 .*x(3) + 0.03638 .*x(4) -0.010867 .*x(1).^2 ...
...
o(2)= 13.1 + 3.722.*x(1) + 0.2003 .*x(2) - 0.0122 .*x(3) + 0.0451 .*x(4) - 0.03047 .*x(1).^2 ...
...
o(3) = -29.0 - 0.36.*x(1) + 0.287 .*x(2) + 0.0659 .*x(3) + 0.0133 .*x(4) - 0.01807 .*x(1).^2 ...
