...
urdu_letter = imread('zentangle.jpg');
...
totalCoordinates = 1;
coordinates{1,1} = [75,102];
coordinates{1,2} = [117,229];
coordinates{1,3} = [94,368];
coordinates{1,4} = [233,96];
coordinates{1,5} = [225 244];
coordinates{1,6} = [243,386];
coordinates{1,7} = [334,105];
coordinates{1,8} = [366,221];
coordinates{1,9} = [332,375];
found = 1;
for iter = 1:1000
    tc = size(coordinates);
    totalCoordinates = 0;
